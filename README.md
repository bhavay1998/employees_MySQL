...
## About the database
The script used to develop the <i>employees</i> database is ```database/employees_db_creation.sql```. <br>
![Employees Database - Schema](employees_MySQL/database/employees_db_schema.jpg) <br>
<br>
